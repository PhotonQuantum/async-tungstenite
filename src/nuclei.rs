...
type TcpStream = Handle<StdTcpStream>;

use super::{domain, port, WebSocketStream};

#[cfg(not(any(feature = "async-tls", feature = "real-async-native-tls")))]
...
#[cfg(all(feature = "async-tls", not(feature = "real-async-native-tls")))]
...
#[cfg(any(feature = "async-tls", feature = "real-async-native-tls"))]
